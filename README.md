...
|      Instance      |    Module   | Total LUTs | SRLs | FFs | RAMB36 | DSP Blocks |
|--------------------|-------------|------------|------|-----|--------|------------|
| shell              |       (top) |         88 |    0 | 302 |      0 |          0 |
| - (shell)          |       (top) |          0 |    0 |   0 |      0 |          0 |
| - user_logic_i     |  user_logic |         88 |    0 | 302 |      0 |          0 |
| --- (user_logic_i) |  user_logic |         68 |    0 | 230 |      0 |          0 |
| --- tap_decoder_i  | tap_decoder |          2 |    0 |   9 |      0 |          0 |
| --- tap_encoder_i  | tap_encoder |         18 |    0 |  63 |      0 |          0 |
